...
ActiveRecord::Schema.define(:version => 20110406103313) do
  ...
  add_foreign_key "instances", "classtypes", :name => "sys_c0034459"
  add_foreign_key "instances", "subsystems", :name => "sys_c0034460"

  add_foreign_key "instancevalues", "datatypes", :name => "sys_c0034476"
  add_foreign_key "instancevalues", "instancevaluesets", :name => "sys_c0034475"

  add_foreign_key "instancevaluesets", "instances", :name => "sys_c0034467"
  add_foreign_key "instancevaluesets", "shots", :name => "sys_c0034466"

  add_foreign_key "shots", "experiments", :name => "sys_c0034435"
  add_foreign_key "shots", "shottypes", :name => "sys_c0034436"
